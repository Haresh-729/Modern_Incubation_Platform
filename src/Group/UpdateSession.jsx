...
function UpdateSession() {
  ...
  const handleSubmit = ()=>{
    if(values.sname === " " || values.heldby === " " || values.abouthost ===" " || values.desc === " "){
            ...
            <div className="h-fit w-fit mx-auto">
                <form className="font-bold lg:mt-8 md:mt-4 mt-2 grid justify-items-end">
                    <label className="lg:ml-0 md:ml-0 sm:ml-0 xl:ml-0 ml-4">
                        Session Name:
                        <input required type="text" name="sname" className="lg:ml-20 md:ml-16 text-white bg-offwhite bg-opacity-20 lg:rounded-xl md:rounded-xl rounded-md lg:w-72 md:w-64 w-56 lg:h-8 md:h-6 h-6 lg:p-3 md:p-2 p-1" />
                    </label>

                    <label className="lg:ml-0 md:ml-0 sm:ml-0 xl:ml-0 ml-4 mt-3">
                        Held By:
                        <input required type="text" name="heldby" className="lg:ml-20 md:ml-16 text-white bg-offwhite bg-opacity-20 lg:rounded-xl md:rounded-xl rounded-md lg:w-72 md:w-64 w-56 lg:h-8 md:h-6 h-6 lg:mt-4 md:mt-3 lg:p-3 md:p-2 p-1" />
                    </label>

                    <label className="lg:ml-0 md:ml-0 sm:ml-0 xl:ml-0 ml-4 mt-3">
                        About The Host:
                        <input  required type="text" name="host" className="lg:ml-20 md:ml-16 text-white bg-offwhite bg-opacity-20 lg:rounded-xl md:rounded-xl rounded-md lg:w-72 md:w-64 w-56 lg:h-8 md:h-6 h-6 lg:mt-4 md:mt-3 lg:p-3 md:p-2 p-1" />
                    </label>
                    ...
                    <label className="lg:flex md:flex lg:ml-0 md:ml-0 sm:ml-0 xl:ml-0 ml-4 mt-3">
                        ...
                        <textarea required name="desc" className="lg:ml-20 md:ml-16 text-white lg:h-20 md:h-16 h-14 bg-offwhite bg-opacity-20 lg:rounded-xl rounded-md md:rounded-xl lg:w-72 md:w-64 w-56 lg:mt-4 md:mt-3 lg:p-3 md:p-2 p-1" />
                    </label>
