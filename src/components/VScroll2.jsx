...
function VScroll2() {
  ...
  return (
    <div data-aos="fade-up" className="bg-[#6788D3] bg-opacity-30 rounded-3xl mt-[3rem] md:mt-[0rem] ">
            <div className="flex">
                ...
                <span className="lg:text-xl text-blue font-poppins tracking-wide font-bold pt-3 flex items-center">DOCUMENTS UPLOADING</span>
            </div>
            <div className="pb-8">
            {/* row 1 */}
            <div className="flex bg-white bg-opacity-50 rounded-3xl shadow-sm shadow-gray-500 lg:mx-10 lg:px-6 lg:mt-8 lg:pb-6 md:mx-10 md:px-6 md:mt-8 md:pb-6 sm:mx-8 sm:px-4 sm:mt-6 sm:pb-4 xl:mx-10 xl:px-6 xl:mt-8 xl:pb-6 mx-4 px-2 mt-4 pb-4">
                {/* text div */}
                <div>
                    <h2 className="text-gray-500 font-bold lg:text-lg md:text-lg xl:text-xl  sm:text-md text-sm lg:py-6 xl:py-6 md:py-4 sm:py-4 py-2">PERSONAL IDENTITY</h2>
                    <div className="lg:text-md xl:text-lg md:text-md sm:text-sm text-[0.8rem] text-gray-600 lg:pt-2">
                        Upload your original personal identity proof such as AAADHAR Card, PAN Card, Driving License, etc.
                    </div>
                    
                    <input type="file" id="File" name="File" accept="images/*" onChange={handleAadharChange} className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  lg:w-[36rem] w-[19rem] mt-[1rem] font-bold bg-white rounded-full lg:px-10 md:px-6 px-4 lg:py-1 md:py-1 py-1 text-blue hover:border-blue border-4"/>
                    
                    <div className="lg:pt-8 md:pt-8 xl:pt-8 sm:pt-6 pt-4 flex flex-wrap mx-auto justify-center items-center">
                    
                        <button onClick={handleAadharSubmit} className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  font-bold bg-blue rounded-full lg:px-10 md:px-6 px-4 lg:py-1 md:py-1 py-1 text-white hover:border-white border-4">
                            Upload
                        </button>
                        ...
                        <div className="flex">
                            ...
                            <div className="text-gray-500 lg:text-sm xl:text-base md:text-sm sm:text-xs text-[0.6rem] pl-2">
                                Must be in .jpg format <hr /> File size must be between 350kb - 2Mb
                            </div>
                        </div>
            ...
            <div className="flex  bg-white bg-opacity-50 rounded-3xl shadow-sm shadow-gray-500 lg:mx-10 lg:px-6 lg:mt-8 lg:pb-6 md:mx-10 md:px-6 md:mt-8 md:pb-6 sm:mx-8 sm:px-4 sm:mt-6 sm:pb-4 xl:mx-10 xl:px-6 xl:mt-8 xl:pb-6 mx-4 px-2 mt-4 pb-4">
                {/* text div */}
                <div>
                    <h2 className="text-gray-500 font-bold lg:text-lg md:text-lg xl:text-xl sm:text-md text-sm lg:py-6 xl:py-6 md:py-4 sm:py-4 py-2 mb-">STUDENT IDENTITY</h2>
                    <div className="lg:text-md xl:text-lg md:text-md sm:text-sm text-[0.8rem] text-gray-600 lg:pt-2">
                    Upload your original School/College/University Identity Card, etc. In case not there, upload your last passed examination certificate 
                    </div>
                    <input type="file" id="File" name="File" accept="images/*" onChange={handlePanChange} className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  lg:w-[36rem] w-[19rem] mt-[1rem] font-bold bg-white rounded-full lg:px-10 md:px-6 px-4 lg:py-1 md:py-1 py-1 text-blue hover:border-blue border-4"
              />
                    <div className="lg:pt-8 md:pt-8 xl:pt-8 sm:pt-6 pt-4 flex flex-wrap mx-auto justify-center items-center">
                        <button onClick={handlePanSubmit} className=" transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  font-bold bg-blue rounded-full lg:px-10 md:px-6 px-4 lg:py-1 md:py-1 py-1 text-white hover:border-white border-4">
                            Upload
                        </button>
    ...
    //     <div className="flex bg-white bg-opacity-50 rounded-3xl shadow-sm shadow-gray-500 lg:mx-10 lg:px-6 lg:mt-8 lg:pb-6 md:mx-10 md:px-6 md:mt-8 md:pb-6 sm:mx-8 sm:px-4 sm:mt-6 sm:pb-4 xl:mx-10 xl:px-6 xl:mt-8 xl:pb-6 mx-4 px-2 mt-4 pb-4">
    //       {/* text div */}
    //       <div className="flex flex-col mr-[15rem]">
