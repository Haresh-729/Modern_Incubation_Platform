          ...
          <div className="bg-cover w-full h-full flex flex-col items-center justify-start">
            ...
            < article className="my-2 w-4/5 sm:w-1/2 border rounded-[2rem] shadow-lg">
              <div className="flex flex-shrink-0 p-4 pb-0">
                ...
                {/* div1 main */}
                <div onClick={() => [setCollab(false), setToggleLike(false), setToggleCmts(false),setShow(!show)]} className=" w-full flex flex-row justify-between">
                  {/* div 1.1 img&name */}
                  <div className="flex">
                    <div>
                      <img
                    ...
                    <div className="ml-3 place-items-center">
                      <p className="cursor-default text-base leading-6 font-medium text-[#304E81]">
                        {username}
                      </p>
                    </div>
                  </div>
                  ...
                  <>
                    ...
                    <div className="pt-2 pl-16 flex flex-row space-x-8 ">
                      ...
                      >
                        ...
                        <a href="https://hareshkurade.me/Chatify"><button
                        id="collab"
