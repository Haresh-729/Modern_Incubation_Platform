...
function KnowMore5() {
    return (
        <div className="select-none  w-full ">
            <div className="flex relative pt-2 mb-10">
                <img
                    ...
                    src="https://i.ibb.co/3kqHs45/Know-More4-1.png"
                ...
                <div className="select-none mt-2 md:mt-4 lg:mt-4 md:mx-6 lg:mx-14 p-2 bg-slate-100 bg-opacity-40 border-4 border-white/60 lg:rounded-tr-[5rem] lg:rounded-bl-[5rem] md:rounded-tr-[3rem] md:rounded-bl-[3rem]">
                    <div className="flex items-center px-2 rounded-br-3xl shadow-md bg-cyan-200 bg-opacity-30 lg:w-1/2 md:w-1/2 w-3/4">
                        <img src="https://i.ibb.co/8c1CKVN/Know-More4-2.png" className="h-14" alt="" />
                    ...
                    <div className="select-none text-[12px] p-2 md:text-xs lg:text-xl text-grey md:p-3 lg:p-5 lg:tracking-wider">
                        <span className="text-orange font-bold">To Do List</span> - An
                        interactive and easy place to store and keep all your tasks at one
                        place group of students can see their common tasks and collectively
                        work on those tasks.
                    </div>
                    <div className="select-none text-[12px] p-2 md:text-xs lg:text-xl text-grey md:p-3 lg:p-5 lg:tracking-wider">
                        <span className="text-[#EFA451] font-bold">Calendar </span>- An user
                        friendly place where one can plan their daily as well as monthly
                        activity safely, securily.
                    </div>
                </div>
            </div>
