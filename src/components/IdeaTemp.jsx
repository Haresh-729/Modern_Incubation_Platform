...
function IdeaTemp({
  ...
  const [ideaDescri, setIdeaDescri]= useState(false);
 
  return (
    <button onClick={() => setIdeaDescri(!ideaDescri)}
    ...
    >
      ...
      <article className=" my-2 w-full  lg:w-1/2 border rounded-[2rem] shadow-lg ">
        <div className="flex flex-shrink-0 px-4 pt-4 pb-0 ">
          ...
          <div className=" w-full flex flex-row justify-between">
            ...
            <div className="flex">
              <div>
                <img
                  className="inline-block h-8 w-8 sm:w-10 sm:h-10 rounded-full"
                  src={imgUrl}
                  alt=""
                ></img>
              </div>
              <div className="ml-3 text-left">
                <p className="text-sm sm:text-base leading-2 font-medium  text-[#304E81]">
                  {name}
                </p>
                <span className="text-xs sm:text-sm align-top leading-2 font-medium text-[#304E81] ">
                  {gmail}
                </span>
              </div>
            </div>
            ...
            <div className="flex justify-items-end space-x-4 ">
              ...
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                class="w-4 h-4 sm:w-6 sm:h-6 hover:stroke-blue"
              >
                <path
              ...
              <button onClick={() => setIdeaDescri(false)}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div className="pl-16  ">
          <div className="flex items-center">
            <h1 className="text-black text-left font-bold sm:text-2xl text-xl pr-4">{title}</h1>
            <button onClick={() => [setStatus(!status),setLike(false)]}>
              <img className="hidden h-5" src={statusLogo} alt="statusLogo"></img>
            </button>
          </div>
         {ideaDescri ? (
         <div>
          <p className="text-sm sm:text-base text-left pr-2 sm:pr-4 width-auto font-medium text-black flex-shrink">
            {description}
          </p>
          <p className="text-sm  width-auto font-medium text-black flex-shrink">
            {file}
          </p>
          </div>)
          : null }
        ...
        <div className="py-1 pl-16 flex flex-row space-x-8 items-center  ">
          <button
            onClick={() => [setLike(!like),setStatus(false)]}
            id="like"
      ...
      {like ? (
        <div className="bg-[#6788D3] bg-opacity-30 shadow-2xl rounded-3xl p-4 float-left">
      ...
      {status? (<div className="  bg-[#6788D3] border rounded-3xl bg-opacity-30 shadow-lg">
       ...
       </div>//switch statement can be used
      //   <div className=" px-8 py-2 bg-[#BCBBBB] border rounded-full bg-opacity-40 font-medium ">
      //     <h1>YOUR IDEA IS UNDER VERIFICATION</h1>
      //  </div>
      ):null
