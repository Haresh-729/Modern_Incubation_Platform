                    ...
                    <form id="form" onSubmit={handleSubmit}>
                        <div className="-mx-3 flex flex-wrap">
                            <div className="w-full px-3">
                                <div className="mb-5">
                                    <Select placeholder="Idea Category" className="w-full  border-b-[0.2rem] rounded-md border-[#7587A4] bg-white py-3 px-6 text-base font-medium text-[#7587A4] outline-none focus:border-blue focus:drop-shadow-2xl" onChange={event => setValues((prev => ({ ...prev, cat: event.value })))} options={options} id="cat" required />
                                </div>
                            </div>
                            <div className="w-full px-3 ">
                                <div className="mb-5">
                                    <input
                                        ...
                                        onChange={event => setValues((prev) => ({ ...prev, title: event.target.value }))} required
                                    />
                                </div>
                            </div>
                            <div className="w-full px-3 ">
                                <div className="mb-5">
                                    <input
                                        ...
                                        className="w-full  border-b-[0.2rem] rounded-md border-[#7587A4] bg-white py-3 px-6 text-base font-medium  outline-none focus:border-blue focus:shadow-md"
                                        onChange={event => setValues((prev) => ({ ...prev, desc: event.target.value }))} required
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="text-red-600 max-w-2xl mx-auto flex justify-center">{pdfFileError}</div>
                        ...
                        <div className="mb-5">
                            <input
                                ...
                                onChange={event => setValues((prev) => ({ ...prev, reason: event.target.value }))} required
                            />
                        </div>
                        <div className="mb-5">
                        ...
                        <div className=" flex justify-center">
                            <button
                                ...
                                onClick={() => notify} disabled={submitButtonDisabled}
                            >
                                Submit
                            </button>
                            <ToastContainer />
