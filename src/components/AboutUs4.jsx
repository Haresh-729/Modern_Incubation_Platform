...
const AboutUs4 = () => {
  return (
    <div className="flex">
      <img data-aos="fade-right" className="mt-[25rem] ml-[30rem]  absolute will-change-scroll" src="https://i.ibb.co/BjHYqT0/cloud4.png" alt="clouds"/>
    <div data-aos="fade-down" className="bg-cover md:pt-7 pt-4 w-screen h-full">
      ...
      <div className="  flex flex-col text-base md:px-4 md:text-sm items-center justify-center  md:grid md:grid-cols-3  md:pt-10 ">
        <div data-aos="flip-up" className="flex item-center lg:mr-8  place-self-end mb-3 rounded-[1.5rem] md:rounded-[3rem] border-4 bg-white bg-opacity-25 h-72 w-72 md:h-60 md:w-60  shadow-2xl">
        ...
        <div data-aos="flip-up" className="flex item-center  mb-3 rounded-[1.5rem] md:rounded-[3rem] border-4 bg-white bg-opacity-25 h-72 w-72 md:h-60 md:w-60  shadow-2xl">
          <p className="leading-relaxed  md:py-2 py-[3vh] px-3 font-semibold text-center  text-[#7587A4]">
        ...
        <div data-aos="flip-down" className="mb-3 rounded-[1.5rem] place-self-end lg:mr-8 md:rounded-[3rem] border-4 bg-white bg-opacity-25 h-72 w-72 md:h-60 md:w-60  shadow-2xl">
          <p className="leading-relaxed  md:py-2 py-[3vh] px-3 font-semibold text-center  text-[#7587A4]">
        ...
        <div data-aos="flip-up" className="content-center mb-3 rounded-[1.5rem] md:rounded-[3rem] border-4 bg-white bg-opacity-25 h-72 w-72 md:h-60 md:w-60
          shadow-2xl">
          <p className="leading-relaxed  md:py-2 py-[3vh] px-3 font-semibold text-center  text-[#7587A4]">
        ...
        <div className="">
          <img data-aos="fade-right" src="https://i.ibb.co/w67pyLV/capa.png" className="hidden   md:max-w-xl md:mt-1" alt="icon" />
        </div>
      </div>
    </div>
    </div>
