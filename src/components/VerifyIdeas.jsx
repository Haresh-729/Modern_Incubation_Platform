...
function VerifyIdeas({
    ...
    useEffect(() => {
        let unsubscribe;
        if (ideaId) {
            unsubscribe = onSnapshot(collection(db, "ideas", ideaId, "comments"), (snapshot) => {
                    ...
                    category === "student" || category === "individual" ?
                        cat === "institute" || cat === "organization" ?
                            <>
                                ...
                                <article hidden={hide} className=" my-2 w-1/2 border rounded-[2rem] shadow-lg">
                                                ...
                                                <>
                                                    ...
                                                    <button onClick={() => {
                                                        updateDoc(doc(db, "ideas", ideaId), {
                                                            status: "not-verified",
                                                            statusLogo: "https://i.ibb.co/ZBDkw5b/icons8-rejected-64-1.png",
                                                        }).then(() => {
