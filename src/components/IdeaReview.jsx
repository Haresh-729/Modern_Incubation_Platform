        ...
        show ? (
          <>
            ...
            <article className=" my-2 w-1/2 border rounded-[2rem] shadow-lg">
              ...
              <div className="pl-16">
                <p className="text-base width-auto font-medium text-black flex-shrink">
                  <a className="text-grey hover:text-gray-300" href={pdfFile}>
                    View Document
                  </a>
                </p>
              </div>
              ...
              status === "not-verified" ? (
                <div className="  bg-[#6788D3] border rounded-3xl bg-opacity-30">
                  ...
                  <div className="mx-6 my-4 border rounded-2xl h-full  bg-[#ffff] text-grey">
                    ...
                    <p className="px-8 py-3 text-xs font-medium tracking-wide overflow-y-auto">
                      The Idea wihich you are trying to upload has been rejected
                      for some reason.
                    </p>
                  </div>
                </div>
                ...
                <div className="  bg-[#6788D3] border rounded-3xl bg-opacity-30">
                  ...
                  <div className="mx-6 my-4 border rounded-2xl h-full  bg-[#ffff] text-grey">
                    ...
                    <p className="px-8 py-3 text-xs font-medium tracking-wide overflow-y-auto">
                      The Idea wihich you are trying to upload has been approved
                      successfully.
                    </p>
                  </div>
                </div>
                ...
                <div className="  bg-[#6788D3] border rounded-3xl bg-opacity-30">
                  ...
                  <div className="mx-6 my-4 border rounded-2xl h-full  bg-[#ffff] text-grey">
                    ...
                    <p className="px-8 py-3 text-xs font-medium tracking-wide overflow-y-auto">
                      The Idea wihich you are trying to upload is under
                      verification.
                    </p>
                  </div>
                </div>
