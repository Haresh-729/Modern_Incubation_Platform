                ...
                <div className="float-none md:float-right flex flex-col items-center justify-center md:w-1/2 lg:w-2/5 py-4 sm:mx-14 md:mx-4 lg:mx-2 lg:py-5  xl:py-14 my-4 lg:my-8 bg-white/30 rounded-[2rem] lg:rounded-[4rem] xl:rounded-[5rem]  border-2 border-offwhite shadow-lg xl:1/3">
                    ...
                    <div className="relative w-full px-10">
                        ...
                        <div className="relative w-full px-10" id='form'>
                            <input onChange={event => setValues((prev) => ({ ...prev, name: event.target.value }))} type="text" name="name" id="name" className=" border-b-2 border-grey shadow-sm bg-white/0 w-full py-2 focus:outline-none focus:shadow-md focus:border-b-blue focus:border-b-2 transition-colors" placeholder='Full Name' autoComplete="on" required pattern="\S+.*" />
                        </div>
                        <div className="relative w-full px-10" id='form'>
                            <input onChange={event => setValues((prev) => ({ ...prev, email: event.target.value }))} type="email" name="email" id="email" className="border-b-2 border-grey shadow-sm bg-white/0 w-full py-2 focus:outline-none focus:shadow-md focus:border-b-blue focus:border-b-2 transition-colors" placeholder='Email' autoComplete="on" required pattern="\S+.*" />
                        </div>
                        <div className="relative w-full px-10">
