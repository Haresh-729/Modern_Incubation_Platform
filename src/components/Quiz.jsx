          ...
          {showResult ? (
            ...
            <>
              <div className="md:mt-8 question-selection mt-4 float-left ">
                <h5 className="md:text-3xl md:ml-8 md:py-4 text-xl font-bold ml-6 py-2">Score:{score}</h5>
              ...
              <div className="answer-selection  ">
                {questions[currentQuestion].answerOptions.map((answerOptions) => (
                  ...
                  <button
                    className={                   
                      'button ${clicked && answerOptions.isCorrect? "correct":"button"} transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 md:text-xl md:w-[20rem] md:h-[3rem] w-[14rem] h-[1rem] md:mx-20 mt-6 py-8  mx-8 flex flex-wrap text-sm text-white rounded-lg bg-[#013BBA] clicked:bg-red  hover:bg-slate-600  place-content-center'
                    }
                    disabled={clicked}
