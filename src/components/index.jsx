...
export { default as AboutUs1 } from "./AboutUs1";
export { default as AboutUs2 } from "./AboutUs2";
export { default as AboutUs3 } from "./AboutUs3";
export { default as AboutUs4 } from "./AboutUs4";
export { default as AboutUs5 } from "./AboutUs5";
...
export { default as IdeaPost } from "./IdeaPost";
export { default as IdeaReview } from "./IdeaReview";
...
export { default as LogoutSuccessful } from "./LogOutSuccessful";
export { default as Maturity } from "./Maturity1";
export { default as Nav } from "./Nav";
export { default as Navbar } from "./Navbar";
export { default as Notification } from "./Notification";
export { default as OurChat } from "./OurChat";
